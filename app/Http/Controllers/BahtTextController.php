...
class BahtTextController extends Controller
{
    ...
    public function bahtText($number, $include_unit = true, $display_zero = true)
    {
        ...
        if ($log > 5) {
            ...
            return $this->bahtText($normalised_million, false) . $millions_text . $this->bahtText($rest, true, false);
        }
        ...
        if ($include_unit) {
            ...
            $text .= $satang == 0
                ...
                : $this->bahtText($satang, false) . self::BAHT_TEXT_SATANG;
        } else {
