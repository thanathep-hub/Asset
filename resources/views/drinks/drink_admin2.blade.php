...
<body>
    <div class="body">
        <div class="container-customize">
            ...
            <div class="nav-admin position-fixed">
                <div class="row">
            ...
            <div class="menu-admin position-fixed bottom-0 start-50 translate-middle-x">
                <div class="row justify-content-center card-menu">
                    <div class="bottom-menu">
                        <button class="btn btn-menu me-2 btn-menu-active">
                        ...
                        <button class="btn btn-menu me-2">
                        ...
                        <button class="btn btn-menu me-2">
                            ...
                            <p class="text-menu-buttom">รายงาน</p>
                        </button>
                    </div>
                </div>
            </div>
