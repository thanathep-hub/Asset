<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto" style="margin-right: 0.5rem;" hidden>
        ...
        <li class="nav-item dropdown">
            <a class="nav-link menu-bar" data-toggle="dropdown" href="#">
                <i class="far fa-bell" style="font-size: 20px;"></i>
                <span class="badge badge-warning navbar-badge" style="font-size: 14px;color:black;"></span>
            </a>
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-center">
                ...
                <a href="#" class="dropdown-item dropdown-footer">ดูการแจ้งเตือนทั้งหมด</a>{{--  /vam/car_maintenance/list --}}
            </div>
        </li>
    </ul>
